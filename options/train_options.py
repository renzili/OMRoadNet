...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--print_freq', type=int, default=108, help='frequency of showing training results on console')
        parser.add_argument('--no_html', action='store_true', help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.name]/web/')
        # network saving and loading parameters
        parser.add_argument('--save_latest_freq', type=int, default=1500, help='frequency of saving the latest results')
        ...
        # training parameters
        parser.add_argument('--n_epochs', type=int, default=51, help='number of epochs with the initial learning rate')
        ...
        parser.add_argument('--lr_D', type=float, default=0.000001, help='initial learning rate for adam')
